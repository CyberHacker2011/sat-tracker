  ...
  return (
    <div className="w-full min-h-screen bg-background relative overflow-x-hidden">
      ...
      <section className="relative mx-auto max-w-7xl px-4 pt-32 pb-16 sm:px-6 lg:px-8">
        <div
          className={`relative text-center max-w-6xl mx-auto transition-all duration-1000 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          {/* Badge Element - Neon Style */}
          <div
            className="inline-flex items-center gap-2.5 px-6 py-3 bg-background/50 backdrop-blur-md
          ...
          >
            ...
            <p className="text-xs font-extrabold text-primary uppercase tracking-[0.2em]">
              {t("hero.badge")}
            </p>
          </div>
          ...
          <h1
            className="text-5xl sm:text-6xl md:text-7xl lg:text-9xl font-black tracking-tight mb-8 leading-tight font-heading
          ...
          >
            ...
            <span
              className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-600 
          ...
          {/* Subtitle */}
          <p
            className="mx-auto max-w-4xl text-xl font-semibold text-secondary/90 leading-relaxed sm:text-2xl md:text-3xl mb-16 px-4
                        animate-in fade-in slide-in-from-bottom-8 duration-1000"
            style={{ animationDelay: "0.4s" }}
          >
            {t("hero.subtitle.plan")}{" "}
            <span className="text-amber-600 dark:text-amber-400 font-black">
              {t("hero.subtitle.smarter")}
            </span>
            .{t("hero.subtitle.study")}{" "}
            <span className="text-blue-600 dark:text-blue-400 font-black">
              {t("hero.subtitle.focused")}
            </span>
            .{t("hero.subtitle.track")}{" "}
            <span className="text-purple-600 dark:text-purple-400 font-black">
              {t("hero.subtitle.progress")}
            </span>
            .
          ...
          >
            {/* Stats Items */}
            <div
              className="group relative bg-card/50 backdrop-blur-lg p-8 rounded-3xl border border-white/10 dark:border-white/5
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="text-sm font-bold text-secondary uppercase tracking-[0.2em]">
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <svg
                    className="w-10 h-10 text-amber-400 fill-current drop-shadow-[0_0_10px_rgba(251,191,36,0.5)]"
                    viewBox="0 0 20 20"
                  >
          ...
          >
            ...
            >
              {t("btn.explore")}
              <svg
                className="w-6 h-6 group-hover:translate-y-1 transition-transform duration-300 text-amber-500"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          {!isAuthenticated && (
            <p
              className="text-base text-secondary/80 font-semibold animate-in fade-in duration-1000"
              style={{ animationDelay: "1s" }}
            >
              {t("login.already_account")}{" "}
              <Link
                href={`${appUrl}/login`}
                className="text-amber-600 dark:text-amber-400 font-black hover:underline decoration-2 underline-offset-4 transition-all"
              >
                {t("btn.signin")} →
              </Link>
            </p>
      ...
      >
        <div
          className="relative rounded-[3rem] bg-gradient-to-br from-amber-600 via-orange-500 to-amber-600 bg-[length:200%_200%] 
                        animate-gradient px-10 py-24 text-center shadow-2xl shadow-amber-500/40 overflow-hidden"
        >
          {/* Decorative animated elements */}
          <div className="absolute inset-0 overflow-hidden opacity-20">
            <div
              className="absolute top-10 left-10 w-24 h-24 border-3 border-white rounded-full animate-ping"
              style={{ animationDuration: "3s" }}
            />
            <div
              className="absolute bottom-10 right-10 w-32 h-32 border-3 border-white rounded-full animate-ping"
              style={{ animationDuration: "4s", animationDelay: "1s" }}
            />
            <div
              className="absolute top-1/2 left-1/4 w-20 h-20 border-3 border-white rounded-full animate-ping"
              style={{ animationDuration: "3.5s", animationDelay: "0.5s" }}
            />
            <div
              className="absolute top-20 right-1/4 w-16 h-16 border-3 border-white rounded-full animate-ping"
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-3 px-7 py-3.5 bg-white/20 backdrop-blur-md rounded-full mb-10 shadow-xl">
              <svg
                className="w-6 h-6 text-amber-200 fill-current animate-pulse"
                viewBox="0 0 20 20"
              >
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-5xl mx-auto mb-14">
              <div
                className="bg-white/10 backdrop-blur-lg p-10 rounded-[2rem] border-3 border-white/40 hover:bg-white/20 
                            transition-all duration-500 hover:scale-105 hover:shadow-2xl shadow-white/20 group"
              >
                <div className="text-white/80 text-sm font-black uppercase tracking-[0.15em] mb-6">
                  {t("plan.monthly")}
                </div>
                <div className="text-6xl font-black text-white mb-3 group-hover:scale-110 transition-transform duration-300">
                  34,540
                </div>
                <div className="text-white/90 text-base font-bold mb-8">
                  {t("plan.per_month")}
                </div>
              ...
              <div
                className="relative bg-white/20 backdrop-blur-lg p-10 rounded-[2rem] border-3 border-amber-200 hover:bg-white/30 
                            transition-all duration-500 hover:scale-105 hover:shadow-2xl shadow-white/20 group"
              >
                <div
                  className="absolute -top-5 left-1/2 -translate-x-1/2 bg-amber-200 text-amber-900 px-6 py-2.5 
      ...
      <section className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div
          className="relative rounded-[3rem] bg-gradient-to-r from-amber-600 via-orange-500 to-amber-600 px-10 py-28 text-center 
      ...
      <footer className="relative mx-auto max-w-7xl px-4 py-12 border-t-2 border-border/50 bg-background/50 backdrop-blur-sm">
        <div className="text-center space-y-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 mb-8">
            <Link
              href={`${appUrl}/about`}
              className="text-base font-black text-secondary hover:text-primary transition-all hover:scale-110 duration-300"
            >
              {t("footer.about")}
            </Link>
            ...
            <Link
              href={`${appUrl}/premium`}
              className="text-base font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent hover:scale-110 transition-transform duration-300"
            >
              Premium
            </Link>
            <span className="hidden sm:block text-border font-bold">|</span>
          ...
          <p className="text-base font-bold text-secondary/70">
            © 2026 SAT Tracker. Built with ❤️ to help students achieve their SAT
            goals.
          </p>
        </div>
      </footer>

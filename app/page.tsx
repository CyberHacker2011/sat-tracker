      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-y-4 rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200">
            ...
            <h3 className="text-xl font-semibold leading-7 text-gray-900">Pomodoro Timer</h3>
            <p className="text-base leading-7 text-gray-600">
              Use the Pomodoro Technique with our beautiful timer. Customize your focus and break durations to match your study style.
            </p>
          </div>

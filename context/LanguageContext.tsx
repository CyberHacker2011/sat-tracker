...
export const LanguageProvider = ({
  ...
  const translations: Record<Language, Record<string, string>> = {
    ...
    uz: {
      ...
      "features.desc":
        "O'qish odatlaringizni o'zgartirish va SAT natijangizni maksimal darajaga ko'tarish uchun aqlli vositalar.",

      "feature.planning.title": "Aqlli Rejalashtirish",
      "feature.planning.desc":
        "Matematika, O'qish va Yozish uchun shaxsiy rejalarni tuzing. Maqsadli sanalarni belgilang va tayyorgarlikni tartibga soling.",

      "feature.pomodoro.title": "Pomodoro Taymeri",
      "feature.pomodoro.desc":
        "Pomodoro usuli bilan diqqatni jamlang. Charchoqni oldini olish uchun avtomatik tanaffuslar bilan o'qing.",

      "feature.analytics.title": "Natijalar Tahlili",
      "feature.analytics.desc":
        "O'qish jarayoningiz haqida batafsil statistikani ko'ring. Soatlar, sessiyalar va o'sish tendentsiyalarini kuzating.",

      "feature.daily.title": "Kunlik Hisobotlar",
      "feature.daily.desc":
        "Kunlik o'quv sessiyalarini qayd eting va natijalarni kuzating. Mavzularni bajarilgan deb belgilang.",

      "feature.room.title": "O'quv Xonasi",
      "feature.room.desc":
        "Maxsus o'quv muhitiga kiring. Kunlik ketma-ketlik va sarflangan vaqtni nazorat qiling.",

      "feature.profile.title": "Profilni Sozlash",
      "feature.profile.desc":
        "Ta'lim darajasi, maqsadli ball va o'qish afzalliklarini belgilang. Tajribangizni moslashtiring.",

      "premium.badge": "Premium Imkoniyatlar",
      "premium.title": "To'liq Imkoniyatlarni Ochish",
      "premium.subtitle":
        "Premium ga o'ting va cheksiz o'quv rejalari, kengaytirilgan tahlillar va ustuvor yordamga ega bo'ling.",
      "premium.footer":
        "Premium obunalar to'g'ridan-to'g'ri aloqa orqali boshqariladi. Faollashtirilgach, oltin yulduz belgisini ko'rasiz.",
      ...
      "reviews.desc":
        "Bizning platformamiz orqali SAT maqsadlariga erishayotgan minglab o'quvchilarga qo'shiling.",
      "reviews.sarah":
        "\"SAT Tracker o'qish tartibimni butunlay o'zgartirdi. Pomodoro taymeri va natijalarni kuzatish meni har kuni mas'uliyatli qildi.\"",
      "reviews.james":
        "\"Rejalashtirish xususiyati ajoyib. Har kuni nima o'qishim kerakligini aniq ko'rib turdim.\"",
      "reviews.emily":
        '"Premium har bir sarflangan so\'mga arziydi. Cheksiz rejalar menga kuchsiz tomonlarimni kuchaytirishga yordam berdi."',
      "reviews.david":
        "\"Batafsil tahlillar qayerda ball yo'qotayotganimni ko'rsatdi. Bir oyda natijam 100 ballga oshdi.\"",
      "reviews.layla":
        "\"Kunlik hisobotlar menga juda yoqadi. Bu meni shunchaki rejalashtirishdan ko'ra, haqiqatdan ham o'qishga undaydi.\"",
      "reviews.scored": "Ball",

      "cta.title": "SAT dan Yuqori Ball Olishga Tayyormisiz?",
      "cta.desc":
        "SAT Tracker dan foydalanib, tartibli va diqqatli bo'lgan minglab o'quvchilarga qo'shiling.",
    ...
    ru: {
      ...
      "hero.subtitle.desc":
        "Ваша универсальная платформа для подготовки к SAT.",
      ...
      "features.desc":
        "Умные инструменты для трансформации ваших учебных привычек и максимизации результата SAT.",

      "feature.planning.title": "Умное Планирование",
      "feature.planning.desc":
        "Создавайте планы для Математики, Чтения и Письма. Устанавливайте цели и организуйте подготовку.",

      "feature.pomodoro.title": "Таймер Pomodoro",
      "feature.pomodoro.desc":
        "Оставайтесь сфокусированными с интервалами Pomodoro. Учитесь блоками с перерывами.",

      "feature.analytics.title": "Аналитика Прогресса",
      "feature.analytics.desc":
        "Подробная статистика о вашем обучении. Отслеживайте часы, сессии и тренды улучшения.",

      "feature.daily.title": "Ежедневные Отчеты",
      "feature.daily.desc":
        "Логируйте учебные сессии и следите за прогрессом. Отмечайте пройденные темы.",

      "feature.room.title": "Учебная Комната",
      "feature.room.desc":
        "Выделенная среда для учебы. Следите за ежедневными сериями и потраченным временем.",

      "feature.profile.title": "Настройка Профиля",
      "feature.profile.desc":
        "Установите уровень образования, целевой балл и предпочтения. Настройте опыт под себя.",

      "premium.badge": "Premium Функции",
      "premium.title": "Раскройте Свой Потенциал",
      "premium.subtitle":
        "Перейдите на Premium и получите безлимитные планы, продвинутую аналитику и приоритетную поддержку.",
      "premium.footer":
        "Подписки Premium управляются напрямую. После активации вы увидите значок золотой звезды.",
      ...
      "reviews.desc":
        "Присоединяйтесь к тысячам студентов, достигающих своих целей SAT с нашей платформой.",
      "reviews.sarah":
        '"SAT Tracker полностью изменил мою рутину. Таймер Pomodoro и трекер прогресса держали меня в тонусе каждый день."',
      "reviews.james":
        '"Функция планирования невероятна. Я точно знал, что учить каждый день."',
      "reviews.emily":
        '"Premium стоил каждого сума. Безлимитные планы помогли мне подтянуть слабые места."',
      "reviews.david":
        '"Детальная аналитика показала, где я терял баллы. Мой результат вырос на 100 баллов за месяц."',
      "reviews.layla":
        '"Обожаю ежедневные отчеты. Это заставляет меня реально учиться, а не просто планировать."',
      "reviews.scored": "Результат",

      "cta.title": "Готовы Сдать SAT на Отлично?",
      "cta.desc":
        "Присоединяйтесь к тысячам студентов, использующих SAT Tracker для организации и мотивации.",

...
export function SettingsToolbar() {
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-80 bg-background/95 backdrop-blur-xl shadow-2xl z-[60] transform transition-transform duration-300 ease-in-out border-l border-border ${
